...
const careers = [
    ...
    {title: "Back-End Developer", text: "Back end developers love understanding how thinks tick, and always have to peek under the hood. You will   be the creator and keeper of the server, database and application of the app. You are the foundation of all websites, without you, the front end developer could not build their interface. Now hole up and code!"}, 
